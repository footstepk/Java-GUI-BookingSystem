...
public class BarberViewBooking {
	 ...
	 */
	public JComponent setPageContentPaneBarber() {
		panel = new JPanel();
...
goBackBtn.addActionListener(listener);
	...
	public void createPageContentPane() {
		...
		frame.add(setPageContentPaneBarber(), BorderLayout.PAGE_END);
